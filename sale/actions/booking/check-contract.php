...
if($status != 'signed') {
    ...
    $dispatch->dispatch('lodging.booking.contract.unsigned', 'sale\booking\Booking', $params['id'], 'important', 'sale_booking_check-contract', ['id' => $params['id']], $links, null, $booking['center_office_id']);
