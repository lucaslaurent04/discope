...
class TaskModel extends \core\followup\TaskModel {
    ...
    public static function getDescription(): string {
        return "A task is generated from a task model when an enrollment is created or change status.";
    }
    ...
    public static function getColumns(): array {
        return [
            ...
            'trigger_event_id' => [
                'type'              => 'many2one',
                'foreign_object'    => 'sale\camp\followup\TaskEvent',
            ...
            'tasks_ids' => [
                ...
                'description'       => "The enrollment tasks generated by the task model."
            ],
